...
\urlstyle{same}
\hypersetup{
  pdftitle={Análise de Evasão Universitária},
...
\title{Análise de Evasão Universitária}
...
\textsubscript{Fonte:
\href{https://ocaiosilv.github.io/evasao-universitaria/index.qmd.html}{Caderno
do Artigo}}
...
O dataset utilizado, \emph{Predict Students' Dropout and Academic
Success} tem como origem o Instituto Politécnico de Portalegre (PP), de
Portugal (Martins \emph{et al.}, 2021, p. 167). Os dados foram coletados
desde 2008 até 2019 (Martins \emph{et al.}, 2021, p. 168). Foi
selecionado devido à relevância acadêmia e por não ter valores faltando
em nenhuma das colunas, facilitando o processo de tratamento para a
análise dos dados.
...
\subsection{Relato Pessoal}\label{relato-pessoal}
...
\textbf{Quarto}Posit Software, PBC, 16 jan. 2026. Disponível em:
\textless{}\url{https://quarto.org}\textgreater{}

\bibitem[\citeproctext]{ref-editorconfig}
EDITORCONFIG TEAM. \textbf{EditorConfig: A file format and collection of
text editor plugins for maintaining consistent coding styles}.
Disponível em: \textless{}\url{https://editorconfig.org}\textgreater.
Acesso em: 25 jan. 2026.

\bibitem[\citeproctext]{ref-github}
GITHUB, INC. \textbf{{GitHub}}. Disponível em:
\textless{}\url{https://github.com}\textgreater. Acesso em: 25 jan.
2026.
...
\bibitem[\citeproctext]{ref-martinsEarlyPredictionStudents2021}
MARTINS, M. V.; TOLLEDO, D.; MACHADO, J.; BAPTISTA, L. M. T.; REALINHO,
V. \href{https://doi.org/10.1007/978-3-030-72657-7_16}{Early
{Prediction} of Student's {Performance} in {Higher Education}: {A Case
Study}}. \emph{Em}: ROCHA, Á.; ADELI, H.; DZEMYDA, G.; MOREIRA, F.;
RAMALHO CORREIA, A. M. (Eds.). \textbf{Trends and {Applications} in
{Information Systems} and {Technologies}}. Cham: Springer International
Publishing, 2021. v. 1365p. 166--175.

\bibitem[\citeproctext]{ref-python}
PYTHON SOFTWARE FOUNDATION. \textbf{Python Language Reference}, 5 dez.
2025. Disponível em:
\textless{}\url{https://www.python.org}\textgreater{}

\bibitem[\citeproctext]{ref-git}
TORVALDS, L.; HAMANO, J. C.; GIT CONTRIBUTORS. \textbf{Git: Distributed
Version Control System}, 17 nov. 2025. Disponível em:
\textless{}\url{https://git-scm.com}\textgreater{}

\bibitem[\citeproctext]{ref-UcimlrepoPackageEasily}
\textbf{Ucimlrepo: {Package} to Easily Import Datasets from the {UC
Irvine Machine Learning Repository} into Scripts and Notebooks.},
{[}s.d.{]}. Disponível em:
\textless{}\url{https://github.com/uci-ml-repo/ucimlrepo/tree/main}\textgreater.
Acesso em: 25 jan. 2026

\bibitem[\citeproctext]{ref-valentimrealinhoPredictStudentsDropout2021}
VALENTIM REALINHO, M. V. M. \textbf{Predict {Students}' {Dropout} and
{Academic Success}}UCI Machine Learning Repository, 2021. Disponível em:
\textless{}\url{https://archive.ics.uci.edu/dataset/697}\textgreater.
